...
- Copying in Excel while Cubby runs no longer intermittently shows Excel's "There's a problem with the clipboard" warning or leaves the first paste empty. Cubby no longer opens the clipboard while Excel is between clearing it and publishing the copy, and reads through OLE so Excel renders without the clipboard locked
